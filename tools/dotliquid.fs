// (Mostly adapted from https://github.com/tpetricek/tomasp.net/blob/master/tools/dotliquid.fs)
module DotLiquid
...
let initialize (cfg:Domain.GenerationOptions) = 
    registerFiltersByName "Filters"
    setTemplatesDir cfg.LayoutsDir
